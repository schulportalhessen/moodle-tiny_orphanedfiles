...
/**
   ...
   */
const initialisedOptionName=(0,_options.getPluginOptionName)(_common.pluginName,"initialised"),userContextIdName=(0,_options.getPluginOptionName)(_common.pluginName,"userContextId"),showReferencecountEnabled=(0,_options.getPluginOptionName)(_common.pluginName,"showreferencecountenabled"),orphanedFilesCounterOnly=(0,_options.getPluginOptionName)(_common.pluginName,"orphanedfilescounteronly");_exports.register=editor=>{const registerOption=editor.options.register;registerOption(userContextIdName,{processor:"number",default:-1}),registerOption(showReferencecountEnabled,{processor:"boolean",default:!1}),registerOption(orphanedFilesCounterOnly,{processor:"boolean",default:!1}),registerOption(initialisedOptionName,{processor:"boolean",default:!1})};_exports.isInitialised=editor=>!!(0,_utils.ensureEditorIsValid)(editor)&&editor.options.get(initialisedOptionName);_exports.getUserContextId=editor=>editor.options.get(userContextIdName);_exports.markInitialised=editor=>editor.options.set(initialisedOptionName,!0);_exports.getShowReferencecountEnabled=editor=>editor.options.get(showReferencecountEnabled);_exports.getOrphanedFilesCounterOnly=editor=>editor.options.get(orphanedFilesCounterOnly)}));
